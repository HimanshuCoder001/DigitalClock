...
public class MyWatch extends JPanel implements Runnable
{
	Thread thread;
	int i,j,k,p=0, q=0;
	...
	private void clockLayout(Graphics g)
	{
		...
		g.drawLine(754,161,815,220);
		g.drawLine(753,160, 815,220);
		g.drawLine(752,159,814,219);
		
		// Clock Circles
		g.setColor(Color.blue);
		g.fillOval(xOrigin - 150, yOrigin - 160, 320,320);
		...
		// String Written Text
		g.setColor(Color.blue);
		g.drawString("Clock Design By Himanshu", 300,100);
	...
	public void paint(Graphics g)
	{
		...
		int str1[] ={0,10,20,30,40,50,58,66,74,80,86,91,94,97,99,100};
		int str2[] ={0,42,69,80};
